...
#aquí se declaran todas las funciones para poder hacer la busqueda de los productos
class ApprovalsRequest(models.Model):
    _inherit = 'approval.request'

    equipment_compute = fields.One2many(comodel_name='equipment.compute', string='Equipo de computo')
